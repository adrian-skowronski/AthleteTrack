...
<div class="container mt-5 mb-5">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-6">
            <form id="editEventForm" method="POST" action="{{ route('admin.events.update', $event->event_id) }}" novalidate>
                @csrf
                @method('PUT')

                <div class="form-group mb-2">
                    <label for="name" class="form-label">Nazwa <em>(wymagane)</em></label>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" maxlength="500" required>{{ $event->description }}</textarea>
                    <div class="invalid-feedback">Nieprawidłowy opis!</div>
                </div>

                <div class="form-group mb-2">
                    <label for="required_category_id" class="form-label">Minimalna kategoria <em>(wymagane)</em></label>
                ...
                <div class="form-group mb-2">
                    <label for="age_from" class="form-label">Wiek od <em>(wymagane)</em></label>
                ...
                <div class="form-group mb-2">
                    <label for="age_to" class="form-label">Wiek do <em>(wymagane)</em></label>
                    ...
                    <div class="invalid-feedback">Nieprawidłowy wiek do! Musi być większy lub równy wiekowi od.</div>
                </div>
                ...
                <div class="form-group mb-2">
                    <label for="start_hour" class="form-label">Godzina <em>(wymagane)</em></label>
                ...
                <div class="form-group mb-2">
                    <label for="max_participants" class="form-label">Maks. liczba uczest. <em>(wymagane)</em></label>
                    ...
                    <div class="invalid-feedback">Nieprawidłowa liczba uczestników! Minimalna 3, maksymalna 299.</div>
                </div>
...
<script>
    (function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            // Sprawdzenie zależności: age_to >= age_from
            var ageFrom = parseInt(document.getElementById('age_from').value, 10);
            var ageTo = parseInt(document.getElementById('age_to').value, 10);
            if (ageTo < ageFrom) {
                valid = false;
                document.getElementById('age_to').classList.add('is-invalid');
            }
            ...
            if (!valid) {
                ...
                // Dodanie klasy is-invalid dla pozostałych pól
                inputs.forEach(function(input) {
