        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarText">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                @if(auth()->user()->isAdmin())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.index') }}">Mój Panel</a>
                    </li>
                @elseif(auth()->user()->isAthlete())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('athlete.panel') }}">Mój Panel</a>
                    </li>
                @elseif(auth()->user()->isCoach())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('trainer.index') }}">Mój Panel</a>
                    </li>
                @endif
                <li class="nav-item">
